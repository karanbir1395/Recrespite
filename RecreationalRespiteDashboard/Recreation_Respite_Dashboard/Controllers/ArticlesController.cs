...
namespace Recreation_Respite_Dashboard.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,name,image,description")] Articles articles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,name,image,description")] Articles articles)
        {
            if (ModelState.IsValid)
            {
